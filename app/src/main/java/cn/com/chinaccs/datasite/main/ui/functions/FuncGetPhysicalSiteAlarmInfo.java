 ...
 */
public class FuncGetPhysicalSiteAlarmInfo {
    private static final String TAG = FuncGetPhysicalSiteAlarmInfo.class.getSimpleName();
    private Context context;

    public FuncGetPhysicalSiteAlarmInfo(Context context) {
    ...
    public void getData(final OnGetDataFinishedListener lr, final String bsId) {
        ...
        new Thread() {
            ...
            public void run() {
                ...
                url.append("BSSiteWarnInfo.do?bsid=").append(bsId)
