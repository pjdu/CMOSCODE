...
public class AssetsContentActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.context = this;
        setContentView(R.layout.activity_assets_content);
        initToolbar("详细信息");
...
//                }
                ...
                try {
                    ...
                    if (!res.equals("1")) {
                        ...
                        if (DAOAssets.getInstance(AssetsContentActivity.this).searchAssetsId(id) != null) {
                            assets = DAOAssets.getInstance(AssetsContentActivity.this).searchAssetsId(id).get(0);
                        }
...
//					cashData(array,new int[]{1,240});//返回缓存数据
    ...
    private class ReadCacheTask extends AsyncTask<String, Void, List<AssetsModel>> {
        ...
        protected List<AssetsModel> doInBackground(String... params) {
            return DAOAssets.getInstance(AssetsContentActivity.this).searchAssetsId(params[0]);
        }
    ...
    public String cashData(JSONArray array, int[] ps) {
        ...
        try {
            ...
            AssetsModel assets = DAOAssets.getInstance(AssetsContentActivity.this).searchAssetsId(id).get(0);
    ...
    static class BsHandler extends Handler {
        ...
        private AssetsContentActivity at;

        public BsHandler(Activity at) {
            this.at = (AssetsContentActivity) at;
        }
