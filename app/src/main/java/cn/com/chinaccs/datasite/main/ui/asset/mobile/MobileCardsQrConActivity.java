 ...
 *
 * Last Modified on 2017-10-20 10:47:59.
 */
...
public class MobileCardsQrConActivity extends BaseActivity {
    ...
    static class BsHandler extends Handler {
        ...
        private MobileCardsQrConActivity at;

        public BsHandler(Activity at) {
            this.at = (MobileCardsQrConActivity) at;
        }
