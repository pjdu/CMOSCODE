 ...
 * 资源信息列表
 */
public class OpticalConItemActivity extends BaseActivity {
    ...
    private OnItemClickListener lrList = new OnItemClickListener() {
        ...
        public void onItemClick(AdapterView<?> arg0, View view, int index,
            ...
            Intent i = new Intent(context, OpticalConItemInfoActivity_.class);
            i.putExtras(be);
        ...
        switch (requestCode) {
            case REQUEST_SERIAL_CODE_SCANNING:
                if (data != null && resultCode == RESULT_OK) {
                    ...
                    if (array != null) {
                        be.putString("json", array.toString());
                        Intent intent = new Intent(context, OpticalConItemInfoActivity_.class);
                        intent.putExtras(be);
        ...
        lvAssets.setOnScrollListener(new AbsListView.OnScrollListener() {
            ...
            public void onScrollStateChanged(AbsListView view, int scrollState) {
                ...
                if (view.getLastVisiblePosition() == (view.getCount() - 1)) {
                    ...
                    final Handler hr = new BsHandler(OpticalConItemActivity.this,
                            true);
                    new Thread(new Runnable() {
    ...
    private void conn(Handler hr) {
        ...
        try {
            ...
            url.append("StationByTypeList.do?siteid=").append(id)
