 ...
 *
 * Last Modified on 2017-10-20 10:47:54.
 */
...
@EActivity(R.layout.activity_asset_mobile_cards_content)
public class MobileCardsConActivity extends BaseActivity {
    ...
    void submitBtnClick() {
        ...
        bundle.putString("ASS_SCAN_CODE", id);
        bundle.putString("ASSET_SN_CODE", assCode);
        bundle.putString("OLD_ASSET_CODE", oldAssetCode);
    ...
    static class BsHandler extends Handler {
        ...
        private MobileCardsConActivity at;

        public BsHandler(Activity at) {
            this.at = (MobileCardsConActivity) at;
        }
