...
public class DSCdmaCellActivity extends Activity {
	...
	private DSCommonListAdapter bsAdapter;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		this.context = this;
		setContentView(R.layout.activity_ds_cdma_cell);
		this.findViews();
		this.buildSp();
		...
		searchType = new String[] {
				getResources().getString(R.string.cell_item_select_name),
				getResources().getString(R.string.cell_item_select_ci) };
			...
			public void onItemSelected(AdapterView<?> arg0, View arg1,
				...
				if (((TextView) arg1).getText() == searchType[0]) {
					etname.setHint(getResources().getString(
							R.string.hint_name_cell));
				} else {
					etname.setHint(getResources().getString(
							R.string.hint_name_cell_ci));
				}
			}
	...
	private void findViews() {
		spArea = (Spinner) findViewById(R.id.sp_cell_area);
		spTown = (Spinner) findViewById(R.id.sp_cell_town);
		etname = (EditText) findViewById(R.id.edit_cell_name);
		btnQuery = (Button) findViewById(R.id.btn_cell_query);
		lvBs = (ListView) findViewById(R.id.lv_cell);
		pbBs = (ProgressBar) findViewById(R.id.pb_cell);
		txtState = (TextView) findViewById(R.id.txt_cell_state);
		spSearchType = (Spinner) findViewById(R.id.sp_cell_search_select);
	}
		...
		lvBs.setOnScrollListener(new OnScrollListener() {
			...
			public void onScrollStateChanged(AbsListView view, int scrollState) {
				...
				if (view.getLastVisiblePosition() == (view.getCount() - 1)) {
					...
					final Handler hr = new BsHandler(DSCdmaCellActivity.this,
							true);
					new Thread(new Runnable() {
		...
		public void handleMessage(Message msg) {
			...
			case 200:
				if (!isPageRequest) {
					...
					activity.bsAdapter = new DSCommonListAdapter(activity,
							activity.listRes);
