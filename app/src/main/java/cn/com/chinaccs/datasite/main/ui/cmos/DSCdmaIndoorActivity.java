...
public class DSCdmaIndoorActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		this.context = this;
		setContentView(R.layout.activity_ds_cdma_indoor);
		this.findViews();
		this.buildSp();
	...
	private void findViews() {
		spArea = (Spinner) findViewById(R.id.sp_indoor_area);
		spTown = (Spinner) findViewById(R.id.sp_indoor_town);
		etname = (EditText) findViewById(R.id.edit_indoor_name);
		btnQuery = (Button) findViewById(R.id.btn_indoor_query);
		lvBs = (ListView) findViewById(R.id.lv_indoor);
		pbBs = (ProgressBar) findViewById(R.id.pb_indoor);
		txtState = (TextView) findViewById(R.id.txt_indoor_state);
	}
		...
		lvBs.setOnScrollListener(new OnScrollListener() {
			...
			public void onScrollStateChanged(AbsListView view, int scrollState) {
				...
				if (view.getLastVisiblePosition() == (view.getCount() - 1)) {
					...
					final Handler hr = new BsHandler(DSCdmaIndoorActivity.this,
							true);
					new Thread(new Runnable() {
	...
	private void conn(Handler hr) {
		...
		try {
			...
			url.append("DSCDMAIndoor.do?userid=").append(userId)
