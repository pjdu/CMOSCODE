 ...
 */
@EActivity(R.layout.activity_asset_mobile_transfer_general)
public class MobileTransferGeneralActivity extends BaseActivity {
    ...
    @ViewById(R.id.et_transfer_cabinet_firm)
    EditText mTransferCabinetFirm;

    @ViewById(R.id.et_transfer_cabinet_type)
    EditText mTransferCabinetType;

    @ViewById(R.id.et_transfer_cabinet_sum)
    EditText mTransferCabinetSum;
    ...
    private void initViews() throws JSONException {
        initToolbar(title);
        transferAssetsNo = array.getString(66);
        ...
        transferSerialId = array.getString(67);
        mTransferCabinetFirm.setText(array.getString(68));
        mTransferCabinetType.setText(array.getString(69));
        mTransferCabinetSum.setText(array.getString(70));
    }
    ...
    private void saveData() {
        ...
        try {
            ...
            data.put(mTransferCabinetFirm.getText().toString().trim());
            data.put(mTransferCabinetType.getText().toString().trim());
            data.put(mTransferCabinetSum.getText().toString().trim());
            SharedPreferences share = getSharedPreferences(App.SHARE_TAG, 0);
            output.put("userid",
