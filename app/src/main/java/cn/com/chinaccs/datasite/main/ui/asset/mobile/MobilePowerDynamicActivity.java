 ...
 */
@EActivity(R.layout.activity_asset_mobile_power_dynamic)
public class MobilePowerDynamicActivity extends BaseActivity {
    ...
    @ViewById(R.id.et_power_monitor_way)
    EditText mPowerMonitorWay;

    @ViewById(R.id.et_power_monitor_valid)
    EditText mPowerMonitorValid;
    ...
    private void initViews() throws JSONException {
       ...
       /* mPowerAssetsNo.setText("");
        mPowerAssetsNo.setOnFocusChangeListener(new View.OnFocusChangeListener() {
            @Override
            public void onFocusChange(View v, boolean hasFocus) {
                if (hasFocus) {
                    mPowerAssetsNo.clearFocus();
                    Intent intent = new Intent(context, AssetsCheckCardsActivity.class);
                    startActivityForResult(intent, REQUEST_ASSETS_CODE_SCANNING);
                }
            }
        });*/
        mPowerMonitorWay.setText(array.getString(51));
        mPowerMonitorValid.setText(array.getString(52));
    }
    ...
    @Click(R.id.btn_power_monitor_way)
    void monitorWayBtnClick() {
        final String[] items = new String[]{"铁塔动环", "干接点", "铁塔动环+干接点", "无监控"};
        DialogInterface.OnClickListener dlr = new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog,
                                int index) {
                // TODO Auto-generated method stub
                mPowerMonitorWay.setText(items[index]);
                dialog.dismiss();
            }
        };
    ...
    @Click(R.id.btn_power_monitor_valid)
    void monitorValidBtnClick() {
        ...
        DialogInterface.OnClickListener dlr = new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog,
                                int index) {
                // TODO Auto-generated method stub
                mPowerMonitorValid.setText(items[index]);
                dialog.dismiss();
            }
        };
        new AlertDialog.Builder(context)
    ...
    private void saveData() {
        ...
        try {
            data.put(mPowerMonitorWay.getText().toString().trim());
            data.put(mPowerMonitorValid.getText().toString().trim());
            SharedPreferences share = getSharedPreferences(App.SHARE_TAG, 0);
            output.put("userid",
