 ...
 */
public class PhysicalSitePayActivity extends BaseActivity {

    private static final String TAG = PhysicalSitePayActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initToolbar("验收交付");
        context = PhysicalSitePayActivity.this;
        this.initMapView();
    ...
    private void initPhycal_new_check_apply_pay() {
        ...
        btn_physicalCheck.setText("验收交付");
    }
            ...
            public boolean onMarkerClick(final Marker marker) {
                ...
                btn_physicalCheck.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        int type = 0;
                        upLoad(type, ids);*/
                        Intent intent = new Intent(PhysicalSitePayActivity.this, PhysicalSiteChekApplyPayContentActivity.class);
