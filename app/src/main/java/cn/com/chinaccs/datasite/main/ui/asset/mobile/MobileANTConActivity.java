 ...
 */
@EActivity(R.layout.activity_asset_mobile_ant_content)
public class MobileANTConActivity extends BaseActivity {
    ...
    @ViewById(R.id.et_ant_ant_name)
    EditText mAntNameEt;

    @ViewById(R.id.et_ant_assets_no)
    EditText mAssetsNoEt;
    @ViewById(R.id.btn_ant_assets_no)
    Button mAssetsNoBtn;

    @ViewById(R.id.et_ant_serial_id)
    EditText mSerialIdEt;
    @ViewById(R.id.btn_ant_serial_id)
    Button mSerialIdBtn;


    @ViewById(R.id.et_ant_ant_location)
    EditText mAntLocationEt;

    @ViewById(R.id.et_ant_lon)
    EditText mLonEt;
    @ViewById(R.id.btn_ant_lon)
    Button mLonBtn;

    @ViewById(R.id.et_ant_lat)
    EditText mLatEt;
    @ViewById(R.id.btn_ant_lat)
    Button mLatBtn;
    ...
    private void initViews() throws JSONException {
        ...
        mAntNameEt.setText(array.getString(36));
        mAssetsNoEt.setText(array.getString(39));
        ...
        mSerialIdEt.setText(array.getString(43));
        mAntLocationEt.setText(array.getString(12));
    ...
    void antAssetsLinkBtnCLick() {
        Bundle be = new Bundle();
        be.putString("id", id);
        be.putString("type", "ANT");
        be.putString("title", "ANT资产卡片");
        Intent intent = new Intent(context, MobileLinkedCardsActivity.class);
        intent.putExtras(be);
        startActivity(intent);
    }

    @Click(R.id.btn_ant_assets_no)
    void antAssetsNoClick() {
        Bundle be = new Bundle();
    ...
    @Click(R.id.btn_ant_serial_id)
    void antSerialIdClick() {
        Bundle be = new Bundle();
    ...
    static class DsHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case 200:
                    Toast.makeText(context, "卡片关联成功!", Toast.LENGTH_LONG).show();
    ...
    private void saveData() {
        ...
        try {
            ...
            data.put(32, assScanCode);
            data.put(36, resScanSn);*/
