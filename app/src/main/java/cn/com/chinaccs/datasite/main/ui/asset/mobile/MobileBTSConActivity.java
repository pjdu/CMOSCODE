 ...
 *
 * Last Modified on 2017-10-26 17:57:17.
 */
...
@EActivity(R.layout.activity_asset_mobile_bts_content)
public class MobileBTSConActivity extends BaseActivity {
    ...
    @ViewById(R.id.et_bts_bts_name)
    EditText mBtsNameEt;

    @ViewById(R.id.et_bts_assets_no)
    EditText mAssetsNoEt;

    @ViewById(R.id.et_bts_serial_id)
    EditText mSerialIdEt;

    @ViewById(R.id.et_bts_place_addr)
    EditText mPlaceAddrEt;

    @ViewById(R.id.et_bts_lon)
    EditText mLonEt;

    @ViewById(R.id.et_bts_lat)
    EditText mLatEt;
    ...
    private void initViews() throws JSONException {
        ...
        mBtsNameEt.setText(array.getString(11));
        mAssetsNoEt.setText(array.getString(32));
        ...
        mSerialIdEt.setText(array.getString(37));
        mPlaceAddrEt.setText(array.getString(3));
        mLonEt.setText(array.getString(16));
        mLatEt.setText(array.getString(17));
    }
    ...
    void btsAssetsLinkBtnCLick() {
        Bundle be = new Bundle();
        be.putString("id", id);
        be.putString("type", "BTS");
        be.putString("title", "BTS资产卡片");
        Intent intent = new Intent(context, MobileLinkedCardsActivity.class);
        intent.putExtras(be);
        startActivity(intent);
    }

    @Click(R.id.btn_bts_assets_no)
    ...
    private void saveData() {
        ...
        try {
            ...
            data.put(30, assScanCode);
            data.put(35, resScanSn);*/
