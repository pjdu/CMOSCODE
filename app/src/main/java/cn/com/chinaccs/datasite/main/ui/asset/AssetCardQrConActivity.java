 ...
 */
@EActivity(R.layout.activity_asset_card_item_con)
public class AssetCardQrConActivity extends BaseActivity {
    ...
    static class BsHandler extends Handler {
        ...
        private AssetCardQrConActivity at;

        public BsHandler(Activity at) {
            this.at = (AssetCardQrConActivity) at;
        }
