...
public class ProductModelIndexAdapter extends BaseAdapter {
	private List<JSONArray> list;
	private Context context;

	public ProductModelIndexAdapter(Context context, List<JSONArray> list) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		try {
			...
			String field2 = data.getString(1);
