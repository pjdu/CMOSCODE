 ...
 * 
 */
public class FuncGetAgentCompany {

	private Context context;

	public FuncGetAgentCompany(Context context) {
		this.context = context;
	}

	public void getData(final OnGetDataFinishedListener lr, final String areaName) {
