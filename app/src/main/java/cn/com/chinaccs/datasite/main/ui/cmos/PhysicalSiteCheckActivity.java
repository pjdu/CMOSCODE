 ...
 */
public class PhysicalSiteCheckActivity extends BaseActivity {

    private static final String TAG = PhysicalSiteCheckActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initToolbar("站址验收");
        context = PhysicalSiteCheckActivity.this;
        this.initMapView();
    ...
    private void initPhycal_new_check_apply_pay() {
        ...
        btn_physicalCheck.setText("站址验收");
    }
    ...
    private void showBSToMap(int type) {
        ...
        if (!bsListFail.isEmpty()) {
            for (BaseSiteBean bs : bsListFail) {
                // 基站经纬度传回来的存在""
                if (bs.getBsLatitude().equals("") || bs.getBsLongitude().equals("")) {
                    continue;
                }
        ...
        mBaiduMap.setOnMarkerClickListener(new BaiduMap.OnMarkerClickListener() {
            ...
            public boolean onMarkerClick(final Marker marker) {
                ...
                btn_physicalCheck.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent intent = new Intent(PhysicalSiteCheckActivity.this, PhysicalSiteChekApplyPayContentActivity.class);
