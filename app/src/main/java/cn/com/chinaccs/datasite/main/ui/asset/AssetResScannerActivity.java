 ...
 *
 * Last Modified on 2017-12-03 14:41:10.
 */
...
public class AssetResScannerActivity extends BaseScannerActivity implements MessageDialogFragment.MessageDialogListener,
    ...
    public void handleResult(Result rawResult) {
        ...
        if (rIndex >= 0) {
            ...
            RNO = result.substring(rIndex + 4, eIndex);
        }
        getResItemInfo(RNO);
    }
    ...
    private void resConn(String resCode) {
        ...
        try {
            ...
            extras.putString("json", array.get(0).toString());
