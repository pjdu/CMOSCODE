 ...
 * 资产列表信息
 */
public class AssetMobileANTAdapter extends BaseAdapter {
    private List<JSONArray> list;
    private Context context;

    public AssetMobileANTAdapter(Context context, List<JSONArray> list) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        convertView = inflater.inflate(R.layout.item_list_asset_mobile_ant, null);
        try {
            JSONArray data = list.get(position);
            String btsName = data.getString(36);
            String assetsNo = data.getString(39);
            String serialId = data.getString(43);
            String assetsAddr = data.getString(12);
            String city = data.getString(9);
