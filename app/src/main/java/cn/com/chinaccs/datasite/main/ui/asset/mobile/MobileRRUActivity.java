...
import cn.com.chinaccs.datasite.main.ui.adapters.AssetMobileRRUAdapter;
import cn.com.chinaccs.datasite.main.zbar.ScannerActivity;

public class MobileRRUActivity extends BaseActivity {
    ...
    private AssetMobileRRUAdapter assetsAdapter;

    private Bundle be = null;
    private String title = null;
    private String id = null;

    private JSONArray btsArray;
    private String btsStr;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_asset_mobile_rru);
        context = this;
        ...
        id = be.getString("id");
        // id = "23146";
        btsStr = be.getString("bts");
        if (null != btsStr) {
            try {
                btsArray = new JSONArray(btsStr);
    ...
    private OnItemClickListener lrList = new OnItemClickListener() {
        ...
        public void onItemClick(AdapterView<?> arg0, View view, int index,
            ...
            Intent i = new Intent(context, MobileRRUConActivity_.class);
            i.putExtras(be);
        ...
        switch (requestCode) {
            case REQUEST_SERIAL_CODE_SCANNING:
                if (data != null && resultCode == RESULT_OK) {
                    ...
                    if (array != null) {
                        be.putString("json", array.toString());
                        Intent intent = new Intent(context, MobileRRUConActivity_.class);
                        intent.putExtras(be);
    ...
    private void conn(Handler hr) {
        ...
        try {
            ...
            url.append("AssetsRruList.do?PSITE_NO=").append(id)
            ...
            for (int i = 0; i < array.length(); i++) {
                ...
                for (int b = 0; b < btsArray.length(); b++) {
                    JSONArray bts = btsArray.getJSONArray(b);
                    if (bts.getString(1).equals(data.getString(4))) {
                        data.put(bts.getString(11));
                    }
                }
                listRes.add(data);
            }
    ...
    static class BsHandler extends Handler {
        ...
        private MobileRRUActivity activity;

        public BsHandler(Activity activity) {
            this.activity = (MobileRRUActivity) activity;
        }
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case 200:
                    ...
                    activity.assetsAdapter = new AssetMobileRRUAdapter(activity,
                            activity.listRes);
