...
public class AssetWelcomeActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_asset_welcome);
        // 禁止MTA打印日志
    ...
    static class Myhandler extends Handler {
        ...
        private void sleepTimes(int times) {
            final Intent intent = new Intent(context, AssetLoginActivity.class);
