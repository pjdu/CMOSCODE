 ...
 *
 * Last Modified on 2017-10-26 09:49:00.
 */
 ...
 * 局站列表信息Adapter
 */
public class AssetOpticalInfoAdapter extends BaseAdapter {
    private List<JSONArray> list;
    private Context context;

    public AssetOpticalInfoAdapter(Context context, List<JSONArray> list) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        try {
            ...
            String assetsAddr = data.getString(5);
            String assetsArea = data.getString(2);
            TextView txtName = (TextView) convertView
                    .findViewById(R.id.res_ass_code);
            txtName.setText("局站名称:" + assetsName);
            TextView txtNum = (TextView) convertView
                    .findViewById(R.id.res_ass_name);
            txtNum.setText("局站位置:" + assetsArea + "-" + data.getString(3) + "-" + data.getString(4));
