...
public class HttpFirstTestActivity extends BaseActivity {
    private static final String TAG = HttpFirstTestActivity.class.getSimpleName();
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case 1: {
                    ...
                    //			post.postData(lr, busiJsonDatas.toString());
...
//		tvTestResult = (TextView) v.findViewById(R.id.tv_test_result);
        ...
        moreInfoBtn.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(HttpFirstTestActivity.this, HttpTestRecordsActivity.class);
                startActivity(intent);
            }
        });
        initCollectInfo();
