...
public class AssetLoginActivity extends BaseActivity {
    ...
    /**
     * Permission required to read phone state, Used by the {@link AssetLoginActivity}
     */
    private static final String[] PERMISSION_PHONE_STATE = {
            Manifest.permission.READ_PHONE_STATE
    };
    /**
     * Permissions required to access and fine location, Used by the {@link AssetLoginActivity}
     */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_asset_login);
        this.findViews();
        this.autoLogin();
    ...
    private void autoLogin() {
        ...
        if (share.getBoolean(AppCheckLogin.SHARE_IF_AUTOLOGIN, false)
            ...
            StringBuffer url = new StringBuffer(DataSiteStart.HTTP_SERVER_URL)
                    ...
                    .append(sign);
            Intent intent = new Intent(context, AssetMainActivity.class);
