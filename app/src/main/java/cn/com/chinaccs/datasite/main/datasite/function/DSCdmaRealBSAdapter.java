...
public class DSCdmaRealBSAdapter extends BaseAdapter {
	private List<JSONArray> list;
	private Context context;

	public DSCdmaRealBSAdapter(Context context, List<JSONArray> list) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		try {
			...
			String field1 = data.getString(3);
			String field2 = data.getString(4);
			String bsType = data.getString(6);
			...
			if (bsType.equals("bs")) {
				txtField2.setText(field2 + "基站");
			} else if (bsType.equals("cell")) {
				txtField2.setText(field2 + "RRU");
			} else {
