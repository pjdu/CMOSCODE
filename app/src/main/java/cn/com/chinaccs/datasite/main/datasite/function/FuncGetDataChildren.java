 ...
 * 
 */
public class FuncGetDataChildren {

	private Context context;

	public FuncGetDataChildren(Context context) {
		this.context = context;
	}

	public void getData(final OnGetDataFinishedListener lr, final String tag) {
		...
		new Thread() {
			...
			public void run() {
				...
				url.append("DataChildren.do?userid=").append(userid)
						.append("&tag=").append(tag).append("&sign=")
						.append(sign);
